...
El formulario de `html/contacto.html` valida 6 campos (nombre, empresa, correo, teléfono, tamaño de empresa y mensaje) y guarda cada envío como un registro en el `localStorage` del navegador (clave `securenet_contactos`), ya que el sitio se aloja en un hosting estático gratuito sin backend.
